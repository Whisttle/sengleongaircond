...
class HomePage(AbstractEmailForm):
    ...
    # Shopee Floating Button Settings
    shopee_button_enabled = models.BooleanField(
        default=False,
        help_text="Enable/disable the Shopee floating button"
    )
    shopee_url = models.URLField(
        blank=True,
        default="https://shopee.com.my/",
        help_text="URL to your Shopee store"
    )
    shopee_button_text = models.CharField(
        max_length=50,
        blank=True,
        default="",
        help_text="Optional text to display next to the Shopee icon (leave blank for icon only)"
    )
    ...
    contact_panels = [
        ...
        MultiFieldPanel([
            FieldPanel('shopee_button_enabled'),
            FieldPanel('shopee_url'),
            FieldPanel('shopee_button_text'),
        ], heading="Shopee Floating Button"),
